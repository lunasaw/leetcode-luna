...
public class Finding3DigitEvenNumbers2094 {
    ...
    /**
     * 我们也可以从小到大遍历所有 33 位偶数（即 [100, 999][100,999] 闭区间内的所有偶数），并判断对应的三个整数位是否为 {digits}digits 数组中三个不同元素。如果是，则该偶数为目标偶数；反之亦然。
     * <p>
     * 具体地，我们首先用哈希表 {freq}freq 维护 {digits}digits 数组中每个数出现的次数。在遍历偶数时，我们同样用哈希表 {freq}_1freq
     * 1
     * ​
     ...
     * 1
     * ​
     * 中每个元素的出现次数都不大于它在 {freq}freq 中的出现次数。
     * <p>
